...
artifact_rel="runtime/mojo/releases/2.1.0+60ddf70d-4782dcd/coakka-runtime-mojo-2.1.0-source.tar.gz"
package_path="$(coakka_resolve_artifact "${publish_root}" "${artifact_rel}" "${tmp_dir}/artifacts/coakka-runtime-mojo-2.1.0-source.tar.gz")"
