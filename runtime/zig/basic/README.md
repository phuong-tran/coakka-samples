...
program against the C ABI headers, and runs a minimal lifecycle/control smoke.
...
It intentionally does not cover deadletters, request/reply, or cluster behavior.
