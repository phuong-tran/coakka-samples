...
artifact_rel="runtime/zig/releases/1.3.1+0da8c2d9-8ff6f32/coakka-runtime-zig-1.3.1-source.tar.gz"
package_path="$(coakka_resolve_artifact "${publish_root}" "${artifact_rel}" "${tmp_dir}/artifacts/coakka-runtime-zig-1.3.1-source.tar.gz")"
