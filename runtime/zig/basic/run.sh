...
artifact_rel="runtime/zig/releases/2.1.0+60ddf70d-4782dcd/coakka-runtime-zig-2.1.0-source.tar.gz"
package_path="$(coakka_resolve_artifact "${publish_root}" "${artifact_rel}" "${tmp_dir}/artifacts/coakka-runtime-zig-2.1.0-source.tar.gz")"
