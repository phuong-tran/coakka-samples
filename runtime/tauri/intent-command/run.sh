...
artifact_rel="runtime/tauri/releases/2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a-f36c396/coakka-runtime-tauri-intents-2.5.0-source.tar.gz"
...
package_path="$(coakka_resolve_artifact "${publish_root}" "${artifact_rel}" "${tmp_dir}/artifacts/coakka-runtime-tauri-intents-2.5.0-source.tar.gz")"
