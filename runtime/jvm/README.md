...
`coakka.v2:coakka-jvm-native-runtime-v2:2.4.0-gc2f53117-0afb5e9`, built against
native runtime generation `2.4.0+c2f53117`.
...
exact connector names and lifecycle rules shipped by the `2.4.0` artifact when
