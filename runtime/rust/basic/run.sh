...
artifact_rel="runtime/rust/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-rs-2.3.0.tar.gz"
package_path="$(coakka_resolve_artifact "${publish_root}" "${artifact_rel}" "${tmp_dir}/artifacts/coakka-runtime-rs-2.3.0.tar.gz")"
