...
Go runtime samples consume `github.com/phuong-tran/coakka-runtime-go@v1.8.1`.
...
exact connector names and lifecycle rules shipped by `v1.8.1` when integrating
either lane.
