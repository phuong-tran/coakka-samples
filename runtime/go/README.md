...
Go runtime samples consume `github.com/phuong-tran/coakka-runtime-go@v1.8.0`.
...
exact connector names and lifecycle rules shipped by `v1.8.0` when integrating
either lane.
