...
npm, PyPI, and NuGet are independent publication channels. npm is published
and clean-install verified at `2.4.0`; PyPI and NuGet remain at `2.3.0`:
...
npm `2.4.0`, PyPI `2.3.0`, NuGet `2.3.0`, Go `v1.6.0`, and Swift `v2.3.0`
