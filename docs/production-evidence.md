...
| Package-manager execution | Maven Central Runtime, Spring Boot, and Quarkus `2.5.3` are production-signed and public over connector source `0ba485e` and Core `2.5.1+26f7944d`; clean public-coordinate framework consumers pass. The static connector archive train, Go `v1.8.3`, and SwiftPM `v2.5.3` use the same Core generation. npm, PyPI, and NuGet remain independently published at Runtime `2.5.2` over native `2.5.0+4b65d0b2`; their existing registry, signature, and consumer evidence remains valid and is not relabeled as C1. Android `1.2.0` is a signed internal, release-minified candidate only; no Maven publication is planned. Logger coordinates remain independently versioned. | [Runtime Package And Platform Evidence](runtime-package-platform-evidence.md), [npm Runtime 2.5.2](releases/2026-08-20-npm-runtime-2.5.2.md), [PyPI Runtime 2.5.2](releases/2026-08-20-python-runtime-2.5.2-pypi.md), [NuGet Runtime 2.5.2](releases/2026-08-20-nuget-csharp-runtime-2.5.2.md), and [JVM Logger Maven Central 1.2.2](releases/2026-08-17-logger-jvm-maven-central-1.2.2.md) |
