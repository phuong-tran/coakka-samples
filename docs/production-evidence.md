...
| Package-manager execution | Maven Central Runtime `2.5.2` publishes the production-signed connector from source `3ae74f4`: all 50 public files match the candidate byte-for-byte, all five detached signatures verify, and clean Java 8/current-JVM consumers pass. Spring Boot and Quarkus `2.5.2` are independently production-signed, depend exactly on Runtime `2.5.2`, expose its owner-grant APIs through the existing orchestrator, and pass six Java 17 framework lines plus public-coordinate consumers; Logger remains `1.2.2`. npm Runtime `2.5.2` registry tarballs are byte-identical to frozen source `3ae74f4`; clean Node.js basic/deadletter, Bun basic, and Electron intent consumers pass. PyPI Runtime `2.5.2` is byte-identical to its frozen wheel and clean basic, deadletter, and hot-reload consumers pass. NuGet Runtime `2.5.2` passes repository-signature verification; NuGet.org adds only `.signature.p7s`, all 19 candidate entries remain identical, frozen .NET 8/9/10 consumers pass, and a clean public `net8.0` consumer passes. Go `v1.8.2` and SwiftPM `v2.5.2` resolve their remote tags and complete request/reply. All selected Runtime `2.5.2` package channels retain native generation `2.5.0+4b65d0b2`; the patch changes connector owner-grant exposure, documentation, license scope, and package metadata without changing native Core bytes. Logger coordinates remain independently versioned. | [Runtime Package And Platform Evidence](runtime-package-platform-evidence.md), [Framework Adapters Maven Central 2.5.2](releases/2026-08-20-framework-adapters-maven-central-2.5.2.md), [JVM Runtime Maven Central 2.5.2](releases/2026-08-20-jvm-runtime-2.5.2-maven-central.md), [npm Runtime 2.5.2](releases/2026-08-20-npm-runtime-2.5.2.md), [PyPI Runtime 2.5.2](releases/2026-08-20-python-runtime-2.5.2-pypi.md), [NuGet Runtime 2.5.2](releases/2026-08-20-nuget-csharp-runtime-2.5.2.md), [Runtime Go v1.8.2 and SwiftPM v2.5.2](releases/2026-08-20-runtime-go-v1.8.2-swiftpm-v2.5.2.md), [NuGet .NET App-Host Baseline](releases/2026-08-17-dotnet-nuget-app-host-baseline.md), and [JVM Logger Maven Central 1.2.2](releases/2026-08-17-logger-jvm-maven-central-1.2.2.md) |
