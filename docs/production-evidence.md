...
| Package-manager execution | Maven Central Runtime `2.4.1`, framework adapters `2.4.1`, and Logger `1.2.2` retain their signed candidate and clean Java consumer evidence. npm Runtime `2.5.1` registry tarballs are byte-identical to frozen source `11c1555`; clean Node.js basic/deadletter, Bun basic, and Electron intent consumers pass. PyPI Runtime `2.5.1` is byte-identical to its frozen wheel and clean basic, deadletter, and hot-reload consumers pass. NuGet Runtime `2.5.1` passes repository-signature verification; NuGet.org adds only `.signature.p7s`, all 19 candidate entries remain identical, frozen .NET 8/9/10 consumers pass, and a clean public `net8.0` consumer passes. Go `v1.8.1` and SwiftPM `v2.5.1` resolve their remote tags and complete request/reply. All five Runtime patch channels retain native generation `2.5.0+4b65d0b2`; the 2.5.1 change is documentation, license scope, and package metadata only. Logger coordinates remain independently versioned. | [Runtime Package And Platform Evidence](runtime-package-platform-evidence.md), [npm Runtime 2.5.1](releases/2026-08-20-npm-runtime-2.5.1.md), [PyPI Runtime 2.5.1](releases/2026-08-20-python-runtime-2.5.1-pypi.md), [NuGet Runtime 2.5.1](releases/2026-08-20-nuget-csharp-runtime-2.5.1.md), [Runtime Go v1.8.1 and SwiftPM v2.5.1](releases/2026-08-20-runtime-go-v1.8.1-swiftpm-v2.5.1.md), [NuGet .NET App-Host Baseline](releases/2026-08-17-dotnet-nuget-app-host-baseline.md), and [JVM Logger Maven Central 1.2.2](releases/2026-08-17-logger-jvm-maven-central-1.2.2.md) |
