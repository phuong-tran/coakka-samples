...
| Package-manager execution | Exact PyPI `1.4.6` and NuGet `1.4.7` registry samples retain their recorded Linux/Windows evidence. Go `v1.5.0`, Swift `v2.1.0`, and the 2.1.0 artifact mirror are tracked separately; known registry and matching-host gaps remain explicit. | [Runtime Package And Platform Evidence](runtime-package-platform-evidence.md) |
