...
This sample installs the published `coakka-logger` wheel into a temporary
directory and runs a small logger flow.
...
coakka_logger_record sequence=1 level=info category=samples.logger.python.basic message={"event":"hello","language":"python"}
