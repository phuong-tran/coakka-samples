...
case "$(uname -s)" in
  Darwin)
    DYLD_LIBRARY_PATH="${package_root}/native/${platform}" "${build_dir}/coakka_logger_native_c_basic"
    DYLD_LIBRARY_PATH="${package_root}/native/${platform}" "${build_dir}/coakka_logger_native_cpp_basic"
    ;;
  Linux)
    LD_LIBRARY_PATH="${package_root}/native/${platform}" "${build_dir}/coakka_logger_native_c_basic"
    LD_LIBRARY_PATH="${package_root}/native/${platform}" "${build_dir}/coakka_logger_native_cpp_basic"
    ;;
esac
