...
current public release `2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be` on all five listed platforms
```
...
The current public runtime-client release reports:
...
The current public Docker Hub image
