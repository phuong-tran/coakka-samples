...
COAKKA_RUNTIME_CLIENT_DOCKER_BUNDLE_RELEASE_ID="${COAKKA_RUNTIME_CLIENT_DOCKER_BUNDLE_RELEASE_ID:-2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be}"
COAKKA_RUNTIME_CLIENT_DOCKER_BUNDLE_VERSION="${COAKKA_RUNTIME_CLIENT_DOCKER_BUNDLE_VERSION:-2.5.1}"
COAKKA_RUNTIME_CLIENT_DEMO_IMAGE_DEFAULT="docker.io/gabrielgun1983/coakka-runtime-client-demo:2.5.1-26f7944d-remote"
