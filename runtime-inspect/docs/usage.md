...
binary is available. On macOS ARM64, Linux x86_64/ARM64, or Windows x86_64, it
also resolves the published inspect archive from `coakka-publish` and verifies
its checksum against `artifacts/public-artifacts.tsv`.

## Published Archive Smoke

Run the published macOS ARM64, Linux x86_64/ARM64, or Windows x86_64 archive
smoke:
...
Windows ARM64 inspect archives are not published in this drop.
