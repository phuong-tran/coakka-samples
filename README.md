...
Current sample status: the macOS ARM64, Linux x86_64, and Linux ARM64 inspect
archives are published in `coakka-publish`; Windows inspect archives are not
published yet.
...
| Runtime inspect | `1.3.1+e664986` macOS ARM64 and Linux x86_64/ARM64 archives; Windows pending |
...
x86_64/ARM64; Windows inspect archives are pending.
...
| Runtime inspect | public macOS ARM64 and Linux x86_64/ARM64 archives, local/native fallback | `bash run.sh runtime-inspect check` |
