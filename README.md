...
`2.4.0+c2f53117`. Registry-backed npm samples use Runtime `2.5.2` and Logger
`1.2.7`; PyPI samples use Runtime `2.5.2` and Logger `1.2.2`; NuGet samples use
Runtime `2.5.2` and Logger `1.2.3` with a `net8.0` baseline.
