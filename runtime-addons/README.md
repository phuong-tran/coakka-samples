...
| --- | --- | --- |
| [SFTP artifact publisher](artifact-publisher-sftp/README.md) | Acquire and verify an artifact in Service A, then distribute it to Service B through File Lane. | Native `0.2.0+c5656cc8` for Linux ARM64/x86-64, macOS ARM64, and Windows 11 ARM64/x86-64; Runtime `2.3.0+`. |
