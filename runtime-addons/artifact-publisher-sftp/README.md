...
flowchart LR
    ...
    Sender -->|"transfer-scoped grant"| Receiver["Service B: receiver File Lane"]
...
| Service B app host | Destination policy, transfer-scoped receive authorization, receiver lifecycle, and post-transfer activation. |
