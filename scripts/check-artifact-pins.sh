...
required_rows=(
  ...
  "runtime Native package|runtime/native/releases/1.3.1+0da8c2d9/coakka-runtime-native-v2-1.3.1.tar.gz"
  "runtime JVM jar|runtime/jvm/releases/1.3.1+0da8c2d9-8ff6f32/coakka-jvm-native-runtime-v2-1.3.1-g0da8c2d9-8ff6f32.jar"
  "runtime Python wheel|runtime/python/releases/1.3.1+0da8c2d9-8ff6f32/coakka_v2_connector-1.3.1-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/1.3.1+0da8c2d9-8ff6f32/coakka-v2-connector-node-1.3.6.tgz"
  "runtime Bun package|runtime/bun/releases/1.3.1+0da8c2d9-8ff6f32/coakka-v2-connector-bun-1.3.6.tgz"
  "runtime Electron package|runtime/electron/releases/1.3.1+0da8c2d9-8ff6f32/coakka-v2-connector-electron-1.3.6.tgz"
  "runtime Go package|runtime/go/releases/1.3.1+0da8c2d9-8ff6f32/coakka-v2-connector-go-1.3.1.tar.gz"
  "runtime C# package|runtime/csharp/releases/1.3.1+0da8c2d9-8ff6f32/CoAkka.Runtime.1.3.1.nupkg"
  "runtime Rust package|runtime/rust/releases/1.3.1+0da8c2d9-8ff6f32/coakka-runtime-rs-1.3.1-spike.tar.gz"
  "runtime Mojo source package|runtime/mojo/releases/1.3.1+0da8c2d9-8ff6f32/coakka-runtime-mojo-1.3.1-source.tar.gz"
  "runtime Zig source package|runtime/zig/releases/1.3.1+0da8c2d9-8ff6f32/coakka-runtime-zig-1.3.1-source.tar.gz"
  "runtime Tauri source package|runtime/tauri/releases/1.3.1+0da8c2d9-8ff6f32/coakka-runtime-tauri-intents-1.3.1-source.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/1.3.1-g0da8c2d9-8ff6f32/coakka-spring-boot-starter-1.3.1-g0da8c2d9-8ff6f32.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/1.3.1-g0da8c2d9-8ff6f32/coakka-quarkus-extension-1.3.1-g0da8c2d9-8ff6f32.jar"
  "coakka-client linux-x86_64|cli/releases/${expected_runtime_client_native}/coakka-client-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-client linux-aarch64|cli/releases/${expected_runtime_client_native}/coakka-client-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-client macos-aarch64|cli/releases/${expected_runtime_client_native}/coakka-client-v2-1.3.1-macos-aarch64.tar.gz"
  "coakka-client windows-x86_64|cli/releases/${expected_runtime_client_native}/coakka-client-v2-1.3.1-windows-x86_64.tar.gz"
  "coakka-client windows-aarch64|cli/releases/${expected_runtime_client_native}/coakka-client-v2-1.3.1-windows-aarch64.tar.gz"
  "coakka-client docker-demo linux-x86_64|demo/coakka-client/releases/${expected_runtime_client_docker}/coakka-client-docker-demo-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-client docker-demo linux-aarch64|demo/coakka-client/releases/${expected_runtime_client_docker}/coakka-client-docker-demo-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-aarch64|runtime-inspect/native/releases/${expected_runtime_inspect_native}/coakka-runtime-inspect-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-x86_64|runtime-inspect/native/releases/${expected_runtime_inspect_native}/coakka-runtime-inspect-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-runtime-inspect macos-aarch64|runtime-inspect/native/releases/${expected_runtime_inspect_native}/coakka-runtime-inspect-v2-1.3.1-macos-aarch64.tar.gz"
  "coakka-runtime-inspect windows-x86_64|runtime-inspect/native/releases/${expected_runtime_inspect_native}/coakka-runtime-inspect-v2-1.3.1-windows-x86_64.tar.gz"
  "coakka-runtime-inspect windows-aarch64|runtime-inspect/native/releases/${expected_runtime_inspect_native}/coakka-runtime-inspect-v2-1.3.1-windows-aarch64.tar.gz"
)
