...
echo "[runtime-release-lanes] listing"
...
require_sample_listing "runtime/electron/basic"

echo "[runtime-release-lanes] bun"
bash "${repo_root}/run.sh" runtime bun basic

echo "[runtime-release-lanes] tauri intent-command"
...
echo "[runtime-release-lanes] electron basic"
bash "${repo_root}/run.sh" runtime electron basic
