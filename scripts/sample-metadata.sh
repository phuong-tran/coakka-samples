...
COAKKA_PUBLISH_RAW_BASE_DEFAULT="https://raw.githubusercontent.com/phuong-tran/coakka-publish/621f36edcb489c5151348986e76b7ef42893f5e7"

COAKKA_RUNTIME_NATIVE_VERSION="2.3.0"
COAKKA_RUNTIME_NATIVE_RELEASE="2.3.0+a83ab412"
...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime JVM jar|runtime/jvm/releases/2.3.0+a83ab412-3a84c7b/coakka-jvm-native-runtime-v2-2.3.0-ga83ab412-3a84c7b.jar"
  "runtime Python wheel|runtime/python/releases/2.3.0+a83ab412-3a84c7b/coakka_v2_connector-2.3.0-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/2.3.0+a83ab412-3a84c7b/coakka-v2-connector-node-2.3.0.tgz"
  "runtime Bun package|runtime/bun/releases/2.3.0+a83ab412-3a84c7b/coakka-v2-connector-bun-2.3.0.tgz"
  "runtime Electron package|runtime/electron/releases/2.3.0+a83ab412-3a84c7b/coakka-v2-connector-electron-2.3.0.tgz"
  "runtime Go package|runtime/go/releases/2.3.0+a83ab412-3a84c7b/coakka-v2-connector-go-2.3.0.tar.gz"
  "runtime C# package|runtime/csharp/releases/2.3.0+a83ab412-3a84c7b/CoAkka.Runtime.2.3.0.nupkg"
  "runtime Rust package|runtime/rust/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-rs-2.3.0.tar.gz"
  "runtime Swift package|runtime/swift/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-swift-2.3.0.tar.gz"
  "runtime Mojo source package|runtime/mojo/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-mojo-2.3.0-source.tar.gz"
  "runtime Zig source package|runtime/zig/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-zig-2.3.0-source.tar.gz"
  "runtime Tauri source package|runtime/tauri/releases/2.3.0+a83ab412-3a84c7b/coakka-runtime-tauri-intents-2.3.0-source.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/2.3.0-ga83ab412-3a84c7b/coakka-spring-boot-starter-2.3.0-ga83ab412-3a84c7b.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/2.3.0-ga83ab412-3a84c7b/coakka-quarkus-extension-2.3.0-ga83ab412-3a84c7b.jar"
