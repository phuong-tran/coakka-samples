...
COAKKA_SAMPLE_ROWS=(
  ...
  "runtime|zig|basic|Run one native runtime lifecycle and raw request/reply smoke from Zig"
  "runtime|mojo|basic|Run one native runtime lifecycle and raw request/reply smoke from Mojo"
