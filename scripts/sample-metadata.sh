...
COAKKA_PUBLISH_RAW_BASE_DEFAULT="https://raw.githubusercontent.com/phuong-tran/coakka-publish/release/js-native-payload-bridge"
...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime Node package|runtime/node/releases/1.3.2+caff6d6d-6d5ea58/coakka-v2-connector-node-1.3.9.tgz"
  "runtime Bun package|runtime/bun/releases/1.3.2+caff6d6d-6d5ea58/coakka-v2-connector-bun-1.3.9.tgz"
  "runtime Electron package|runtime/electron/releases/1.3.2+caff6d6d-6d5ea58/coakka-v2-connector-electron-1.3.9.tgz"
  ...
  "coakka-client linux-x86_64|cli/releases/1.3.2+caff6d6d/coakka-client-v2-1.3.2-linux-x86_64.tar.gz"
  "coakka-client linux-aarch64|cli/releases/1.3.2+caff6d6d/coakka-client-v2-1.3.2-linux-aarch64.tar.gz"
  "coakka-client macos-aarch64|cli/releases/1.3.2+caff6d6d/coakka-client-v2-1.3.2-macos-aarch64.tar.gz"
  "coakka-client windows-x86_64|cli/releases/1.3.2+caff6d6d/coakka-client-v2-1.3.2-windows-x86_64.tar.gz"
  "coakka-client windows-aarch64|cli/releases/1.3.2+caff6d6d/coakka-client-v2-1.3.2-windows-aarch64.tar.gz"
  "coakka-client docker-demo linux-x86_64|demo/coakka-client/releases/1.3.2+caff6d6d/coakka-client-docker-demo-v2-1.3.2-linux-x86_64.tar.gz"
  "coakka-client docker-demo linux-aarch64|demo/coakka-client/releases/1.3.2+caff6d6d/coakka-client-docker-demo-v2-1.3.2-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-aarch64|runtime-inspect/native/releases/1.3.2+caff6d6d/coakka-runtime-inspect-v2-1.3.2-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-x86_64|runtime-inspect/native/releases/1.3.2+caff6d6d/coakka-runtime-inspect-v2-1.3.2-linux-x86_64.tar.gz"
  "coakka-runtime-inspect macos-aarch64|runtime-inspect/native/releases/1.3.2+caff6d6d/coakka-runtime-inspect-v2-1.3.2-macos-aarch64.tar.gz"
  "coakka-runtime-inspect windows-x86_64|runtime-inspect/native/releases/1.3.2+caff6d6d/coakka-runtime-inspect-v2-1.3.2-windows-x86_64.tar.gz"
  "coakka-runtime-inspect windows-aarch64|runtime-inspect/native/releases/1.3.2+caff6d6d/coakka-runtime-inspect-v2-1.3.2-windows-aarch64.tar.gz"
)
