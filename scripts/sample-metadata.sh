...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime Zig source package|runtime/zig/releases/2.1.0+60ddf70d-4782dcd/coakka-runtime-zig-2.1.0-source.tar.gz"
  "runtime Tauri source package|runtime/tauri/releases/2.1.0+60ddf70d-4782dcd/coakka-runtime-tauri-intents-2.1.0-source.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/2.1.0-g60ddf70d-4782dcd/coakka-spring-boot-starter-2.1.0-g60ddf70d-4782dcd.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/2.1.0-g60ddf70d-4782dcd/coakka-quarkus-extension-2.1.0-g60ddf70d-4782dcd.jar"
  "coakka-client linux-x86_64|coakka-tools/coakka-client/releases/2.1.0+60ddf70d/coakka-client-v2-2.1.0-linux-x86_64.tar.gz"
  "coakka-client linux-aarch64|coakka-tools/coakka-client/releases/2.1.0+60ddf70d/coakka-client-v2-2.1.0-linux-aarch64.tar.gz"
  "coakka-client macos-aarch64|coakka-tools/coakka-client/releases/2.1.0+60ddf70d/coakka-client-v2-2.1.0-macos-aarch64.tar.gz"
  "coakka-client windows-x86_64|coakka-tools/coakka-client/releases/2.1.0+60ddf70d/coakka-client-v2-2.1.0-windows-x86_64.tar.gz"
  "coakka-client windows-aarch64|coakka-tools/coakka-client/releases/2.1.0+60ddf70d/coakka-client-v2-2.1.0-windows-aarch64.tar.gz"
  ...
  "coakka-runtime-inspect linux-aarch64|coakka-tools/coakka-runtime-inspect/releases/2.1.0+60ddf70d/coakka-runtime-inspect-v2-2.1.0-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-x86_64|coakka-tools/coakka-runtime-inspect/releases/2.1.0+60ddf70d/coakka-runtime-inspect-v2-2.1.0-linux-x86_64.tar.gz"
  "coakka-runtime-inspect macos-aarch64|coakka-tools/coakka-runtime-inspect/releases/2.1.0+60ddf70d/coakka-runtime-inspect-v2-2.1.0-macos-aarch64.tar.gz"
  "coakka-runtime-inspect windows-x86_64|coakka-tools/coakka-runtime-inspect/releases/2.1.0+60ddf70d/coakka-runtime-inspect-v2-2.1.0-windows-x86_64.tar.gz"
  "coakka-runtime-inspect windows-aarch64|coakka-tools/coakka-runtime-inspect/releases/2.1.0+60ddf70d/coakka-runtime-inspect-v2-2.1.0-windows-aarch64.tar.gz"
)
