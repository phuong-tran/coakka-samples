...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime Bun package|runtime/bun/releases/1.3.1+bda2ef5-15d262e/coakka-v2-connector-bun-1.3.1.tgz"
  ...
  "runtime Tauri source package|runtime/tauri/releases/1.3.1+bda2ef5-15d262e/coakka-runtime-tauri-intents-1.3.1-source.tar.gz"
