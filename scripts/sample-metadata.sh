...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime Python wheel|runtime/python/releases/0.2.0+c124a9e-c4be778/coakka_v2_connector-0.2.0-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/0.2.0+c124a9e-c4be778/coakka-v2-connector-node-0.2.0.tgz"
  "runtime Go package|runtime/go/releases/0.2.0+c124a9e-c4be778/coakka-v2-connector-go-0.2.0.tar.gz"
  "runtime C# package|runtime/csharp/releases/0.2.0+c124a9e-c4be778/CoAkka.Runtime.0.2.0.nupkg"
  "runtime Rust package|runtime/rust/releases/0.2.0+c124a9e-c4be778/coakka-runtime-rs-0.2.0-spike.tar.gz"
  "runtime Mojo source package|runtime/mojo/releases/0.2.0+c124a9e-c4be778/coakka-runtime-mojo-0.2.0-source.tar.gz"
  "runtime Zig source package|runtime/zig/releases/0.2.0+c124a9e-c4be778/coakka-runtime-zig-0.2.0-source.tar.gz"
