...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime JVM jar|runtime/jvm/releases/0.1.0+a671b3a/coakka-jvm-native-runtime-v2-0.1.1-ga671b3a.jar"
  "runtime Python wheel|runtime/python/releases/0.1.0+a671b3a/coakka_v2_connector-0.1.0-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/0.1.0+a671b3a/coakka-v2-connector-node-0.1.0.tgz"
  "runtime Go package|runtime/go/releases/0.1.0+a671b3a/coakka-v2-connector-go-0.1.0.tar.gz"
  "runtime C# package|runtime/csharp/releases/0.1.0+a671b3a/CoAkka.Runtime.0.1.1.nupkg"
  "runtime Rust package|runtime/rust/releases/0.1.0+a671b3a/coakka-runtime-rs-0.1.0-spike.tar.gz"
