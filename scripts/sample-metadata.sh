...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime JVM jar|runtime/jvm/releases/0.2.0+b8ecfae-1107154/coakka-jvm-native-runtime-v2-0.2.0-gb8ecfae-1107154.jar"
  "runtime Python wheel|runtime/python/releases/0.2.0+c124a9e-66ebe58/coakka_v2_connector-0.2.0-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/0.2.0+c124a9e-66ebe58/coakka-v2-connector-node-0.2.0.tgz"
  "runtime Go package|runtime/go/releases/0.2.0+c124a9e-66ebe58/coakka-v2-connector-go-0.2.0.tar.gz"
  "runtime C# package|runtime/csharp/releases/0.2.0+c124a9e-66ebe58/CoAkka.Runtime.0.2.0.nupkg"
  "runtime Rust package|runtime/rust/releases/0.2.0+c124a9e-66ebe58/coakka-runtime-rs-0.2.0-spike.tar.gz"
  "runtime Mojo source package|runtime/mojo/releases/0.2.0+c124a9e-66ebe58/coakka-runtime-mojo-0.2.0-source.tar.gz"
  "runtime Zig source package|runtime/zig/releases/0.2.0+c124a9e-66ebe58/coakka-runtime-zig-0.2.0-source.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/0.2.0-g11071541ea78/coakka-spring-boot-starter-0.2.0-g11071541ea78.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/0.2.0-g11071541ea78/coakka-quarkus-extension-0.2.0-g11071541ea78.jar"
)
