...
COAKKA_RUNTIME_NATIVE_VERSION="1.4.1"
COAKKA_RUNTIME_NATIVE_RELEASE="1.4.1+9e02a51d"
...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime JVM jar|runtime/jvm/releases/1.4.1+9e02a51d-4e7cda4/coakka-jvm-native-runtime-v2-1.4.1-g9e02a51d-4e7cda4.jar"
  "runtime Python wheel|runtime/python/releases/1.4.1+9e02a51d-603a3728/coakka_v2_connector-1.4.6-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/1.4.1+9e02a51d-37816322/coakka-v2-connector-node-1.4.6.tgz"
  "runtime Bun package|runtime/bun/releases/1.4.1+9e02a51d-37816322/coakka-v2-connector-bun-1.4.6.tgz"
  "runtime Electron package|runtime/electron/releases/1.4.1+9e02a51d-37816322/coakka-v2-connector-electron-1.4.6.tgz"
  "runtime Go package|runtime/go/releases/1.4.1+9e02a51d-4e7cda4/coakka-v2-connector-go-1.4.1.tar.gz"
  "runtime C# package|runtime/csharp/releases/1.4.1+9e02a51d-af244b1e/CoAkka.Runtime.1.4.7.nupkg"
  "runtime Rust package|runtime/rust/releases/1.4.1+9e02a51d-4e7cda4/coakka-runtime-rs-1.4.1.tar.gz"
  "runtime Swift package|runtime/swift/releases/1.4.1+9e02a51d-4e7cda4/coakka-runtime-swift-1.4.1.tar.gz"
  "runtime Mojo source package|runtime/mojo/releases/1.4.1+9e02a51d-4e7cda4/coakka-runtime-mojo-1.4.1-source.tar.gz"
  "runtime Zig source package|runtime/zig/releases/1.4.1+9e02a51d-4e7cda4/coakka-runtime-zig-1.4.1-source.tar.gz"
  "runtime Tauri source package|runtime/tauri/releases/1.4.1+9e02a51d-4e7cda4/coakka-runtime-tauri-intents-1.4.1-source.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/1.4.1-g9e02a51d-4e7cda4/coakka-spring-boot-starter-1.4.1-g9e02a51d-4e7cda4.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/1.4.1-g9e02a51d-4e7cda4/coakka-quarkus-extension-1.4.1-g9e02a51d-4e7cda4.jar"
  "coakka-client linux-x86_64|coakka-tools/coakka-client/releases/1.4.1+9e02a51d/coakka-client-v2-1.4.1-linux-x86_64.tar.gz"
  "coakka-client linux-aarch64|coakka-tools/coakka-client/releases/1.4.1+9e02a51d/coakka-client-v2-1.4.1-linux-aarch64.tar.gz"
  "coakka-client macos-aarch64|coakka-tools/coakka-client/releases/1.4.1+9e02a51d/coakka-client-v2-1.4.1-macos-aarch64.tar.gz"
  "coakka-client windows-x86_64|coakka-tools/coakka-client/releases/1.4.1+9e02a51d/coakka-client-v2-1.4.1-windows-x86_64.tar.gz"
  "coakka-client windows-aarch64|coakka-tools/coakka-client/releases/1.4.1+9e02a51d/coakka-client-v2-1.4.1-windows-aarch64.tar.gz"
  ...
  "coakka-runtime-inspect linux-aarch64|coakka-tools/coakka-runtime-inspect/releases/1.4.1+9e02a51d/coakka-runtime-inspect-v2-1.4.1-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-x86_64|coakka-tools/coakka-runtime-inspect/releases/1.4.1+9e02a51d/coakka-runtime-inspect-v2-1.4.1-linux-x86_64.tar.gz"
  "coakka-runtime-inspect macos-aarch64|coakka-tools/coakka-runtime-inspect/releases/1.4.1+9e02a51d/coakka-runtime-inspect-v2-1.4.1-macos-aarch64.tar.gz"
  "coakka-runtime-inspect windows-x86_64|coakka-tools/coakka-runtime-inspect/releases/1.4.1+9e02a51d/coakka-runtime-inspect-v2-1.4.1-windows-x86_64.tar.gz"
  "coakka-runtime-inspect windows-aarch64|coakka-tools/coakka-runtime-inspect/releases/1.4.1+9e02a51d/coakka-runtime-inspect-v2-1.4.1-windows-aarch64.tar.gz"
)
