...
COAKKA_ARTIFACT_ROWS=(
  ...
  "runtime Native package|runtime/native/releases/0.1.0+3362b67/coakka-runtime-native-v2-0.1.0.tar.gz"
  "runtime JVM jar|runtime/jvm/releases/0.1.0+3362b67/coakka-jvm-native-runtime-v2-0.1.1-g3362b67.jar"
  "runtime Python wheel|runtime/python/releases/0.1.0+3362b67/coakka_v2_connector-0.1.0-py3-none-any.whl"
  "runtime Node package|runtime/node/releases/0.1.0+3362b67/coakka-v2-connector-node-0.1.0.tgz"
  "runtime Go package|runtime/go/releases/0.1.0+3362b67/coakka-v2-connector-go-0.1.0.tar.gz"
  "runtime C# package|runtime/csharp/releases/0.1.0+3362b67/CoAkka.Runtime.0.1.1.nupkg"
  "runtime Rust package|runtime/rust/releases/0.1.0+3362b67/coakka-runtime-rs-0.1.0-spike.tar.gz"
  "Spring Boot starter Maven jar|maven/coakka/spring/coakka-spring-boot-starter/0.1.0-g3362b67/coakka-spring-boot-starter-0.1.0-g3362b67.jar"
  "Quarkus extension Maven jar|maven/coakka/quarkus/coakka-quarkus-extension/0.1.0-g3362b67/coakka-quarkus-extension-0.1.0-g3362b67.jar"
)
