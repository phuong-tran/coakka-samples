...
COAKKA_ARTIFACT_ROWS=(
  ...
  "coakka-client linux-x86_64|cli/releases/1.3.1+0da8c2d9/coakka-client-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-client linux-aarch64|cli/releases/1.3.1+0da8c2d9/coakka-client-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-client macos-aarch64|cli/releases/1.3.1+0da8c2d9/coakka-client-v2-1.3.1-macos-aarch64.tar.gz"
  "coakka-client windows-x86_64|cli/releases/1.3.1+0da8c2d9/coakka-client-v2-1.3.1-windows-x86_64.tar.gz"
  "coakka-client windows-aarch64|cli/releases/1.3.1+0da8c2d9/coakka-client-v2-1.3.1-windows-aarch64.tar.gz"
  "coakka-client docker-demo linux-x86_64|demo/coakka-client/releases/1.3.1+0da8c2d9/coakka-client-docker-demo-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-client docker-demo linux-aarch64|demo/coakka-client/releases/1.3.1+0da8c2d9/coakka-client-docker-demo-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-aarch64|runtime-inspect/native/releases/1.3.1+0da8c2d9/coakka-runtime-inspect-v2-1.3.1-linux-aarch64.tar.gz"
  "coakka-runtime-inspect linux-x86_64|runtime-inspect/native/releases/1.3.1+0da8c2d9/coakka-runtime-inspect-v2-1.3.1-linux-x86_64.tar.gz"
  "coakka-runtime-inspect macos-aarch64|runtime-inspect/native/releases/1.3.1+0da8c2d9/coakka-runtime-inspect-v2-1.3.1-macos-aarch64.tar.gz"
  "coakka-runtime-inspect windows-x86_64|runtime-inspect/native/releases/1.3.1+0da8c2d9/coakka-runtime-inspect-v2-1.3.1-windows-x86_64.tar.gz"
  "coakka-runtime-inspect windows-aarch64|runtime-inspect/native/releases/1.3.1+0da8c2d9/coakka-runtime-inspect-v2-1.3.1-windows-aarch64.tar.gz"
)
